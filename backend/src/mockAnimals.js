// Mock animal library for the local backend mock server (npm run dev:mock).
// Kept in sync with frontend/src/api/mockAnimals.js. Common names are chosen so
// the frontend's live GBIF map resolves a real distribution.
